  ...
  describe("Plugin: mb-auth-plugin (API) [#" .. strategy .. "]", function()
    ...
    describe("/consumers/:consumer/mb-auth-plugin/", function()
      ...
      describe("POST", function()
        ...
        it("creates a mb-auth-plugin credential with tags", function()
          local res = assert(admin_client:send {
            method  = "POST",
            path    = "/consumers/bob/mb-auth-plugin/",
            body    = {
    ...
    describe("/consumers/:consumer/mb-auth-plugin/:id", function()
      ...
      before_each(function()
        db:truncate("mbbasicauth_credentials")
        credential = bp.mbbasicauth_credentials:insert {
          username = "bob",
          password = "kong",
          consumer = { id = consumer.id },
        }
      ...
      describe("GET", function()
        it("retrieves mb-auth-plugin credential by id", function()
          local res = assert(admin_client:send {
            method  = "GET",
        ...
        it("retrieves mb-auth-plugin credential by username", function()
          local res = assert(admin_client:send {
            method  = "GET",
            path    = "/consumers/bob/mb-auth-plugin/" .. credential.username
          })
          local body = assert.res_status(200, res)
          local json = cjson.decode(body)
          assert.equal(credential.id, json.id)
      ...
      describe("PUT", function()
        it("creates a mb-auth-plugin credential", function()
          local res = assert(admin_client:send {
            method  = "PUT",
            path    = "/consumers/bob/mb-auth-plugin/robert",
            body    = {
              password = "kong"
            },
            headers = {
        ...
        describe("errors", function()
          it("returns bad request", function()
            local res = assert(admin_client:send {
              method  = "PUT",
              path    = "/consumers/bob/mb-auth-plugin/b59d82f6-c839-4a60-b491-c6cdff4cd5d3",
              body    = {
                username = 123,
              },
              headers = {
      ...
      describe("DELETE", function()
        ...
        describe("errors", function()
          it("returns 404 on missing username", function()
            local res = assert(admin_client:send {
              method  = "DELETE",
              path    = "/consumers/bob/mb-auth-plugin/blah"
            })
            assert.res_status(404, res)
          end)
    ...
    describe("/mb-auth-plugins", function()
      local consumer2
      describe("GET", function()
        lazy_setup(function()
          db:truncate("mbbasicauth_credentials")
        ...
        it("retrieves all the mb-auth-plugins with trailing slash", function()
          local res = assert(admin_client:send {
            method = "GET",
            path = "/mb-auth-plugins/"
          })
          local body = assert.res_status(200, res)
          local json = cjson.decode(body)
          assert.is_table(json.data)
        ...
        it("retrieves all the mb-auth-plugins without trailing slash", function()
          local res = assert(admin_client:send {
            method = "GET",
            path = "/mb-auth-plugins"
          })
        ...
        it("paginates through the mb-auth-plugins", function()
          local res = assert(admin_client:send {
            method = "GET",
            path = "/mb-auth-plugins?size=1",
          })
          local body = assert.res_status(200, res)
      ...
      describe("POST", function()
        ...
        it("does not create mb-auth-plugin credential when missing consumer", function()
          local res = assert(admin_client:send {
            method = "POST",
            path = "/mb-auth-plugins",
            body = {
        ...
        it("creates mb-auth-plugin credential", function()
          local res = assert(admin_client:send {
            method = "POST",
            path = "/mb-auth-plugins",
            body = {
    ...
    describe("/mb-auth-plugins/:username_or_id", function()
      describe("PATCH", function()
        local consumer2
    ...
    describe("/mb-auth-plugins/:credential_username_or_id/consumer", function()
      describe("GET", function()
        local credential
        lazy_setup(function()
          db:truncate("mbbasicauth_credentials")
        ...
        it("retrieve consumer from a mb-auth-plugin id", function()
          local res = assert(admin_client:send {
            method = "GET",
            path = "/mb-auth-plugins/" .. credential.id .. "/consumer"
          })
          local body = assert.res_status(200, res)
          local json = cjson.decode(body)
          assert.same(consumer,json)
        end)
        it("retrieve consumer from a mb-auth-plugin username", function()
          local res = assert(admin_client:send {
            method = "GET",
            path = "/mb-auth-plugins/" .. credential.username .. "/consumer"
          })
          local body = assert.res_status(200, res)
          local json = cjson.decode(body)
          assert.same(consumer,json)
        end)
        it("returns 404 for a random non-existing mb-auth-plugin id", function()
          local res = assert(admin_client:send {
            method = "GET",
            path = "/mb-auth-plugins/" .. utils.uuid()  .. "/consumer"
          })
          assert.res_status(404, res)
        end)
        it("returns 404 for a random non-existing mb-auth-plugin username", function()
          local res = assert(admin_client:send {
            method = "GET",
            path = "/mb-auth-plugins/" .. utils.random_string()  .. "/consumer"
          })
          assert.res_status(404, res)
        end)
      end)
