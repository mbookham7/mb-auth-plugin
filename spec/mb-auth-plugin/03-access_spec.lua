...
for _, strategy in helpers.each_strategy() do
  describe("Plugin: mb-auth-plugin (access) [#" .. strategy .. "]", function()
    local proxy_client
    ...
    lazy_setup(function()
      ...
      local route1 = bp.routes:insert {
        hosts = { "mb-auth-plugin1.com" },
      }

      local route2 = bp.routes:insert {
        hosts = { "mb-auth-plugin2.com" },
      }

      local route3 = bp.routes:insert {
        hosts = { "mb-auth-plugin3.com" },
      }

      local route4 = bp.routes:insert {
        hosts = { "mb-auth-plugin4.com" },
      }

      local route5 = bp.routes:insert {
        hosts = { "mb-auth-plugin5.com" },
      }
